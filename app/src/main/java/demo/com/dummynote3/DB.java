...
public class DB {
    ...
    private static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS "
        + TABLE_NAME + "(id INTEGER PRIMARY KEY, 機構名稱 VARCHAR, 市 VARCHAR, 區 VARCHAR, 地址 VARCHAR, 電話 VARCHAR, 診療科別 VARCHAR);";
    ...
    private static final String KEY_DIVISIONS = "診療科別";


    String[] strCols = { KEY_ROWID, KEY_NAME, KEY_CITY, KEY_AREA, KEY_ADDRESS, KEY_PHONE, KEY_PHONE, KEY_DIVISIONS };
